    ...
    const fetchAppleWatchProducts = async () => {
      try {
        const response = await axios.get(
          "https://backend-tienda-mac-production-0992.up.railway.app/products/category/Smartwatches%20y%20accesorios/subcategory/Smartwatches/name/Apple%20Watch%20Ultra"
        );
