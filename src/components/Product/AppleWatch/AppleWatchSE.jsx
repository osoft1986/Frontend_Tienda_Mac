    ...
    const fetchAppleWatchProducts = async () => {
      try {
        const responses = await Promise.all([
          axios.get(
            "https://backend-tienda-mac-production-0992.up.railway.app/products/category/Smartwatches%20y%20accesorios/subcategory/Smartwatches/name/Apple%20Watch%20SE%202.ª%20generación"
          ),
        ]);
