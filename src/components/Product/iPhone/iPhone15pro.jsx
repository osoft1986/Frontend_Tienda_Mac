    ...
    const fetchIphoneProducts = async () => {
      try {
        const responses = await Promise.all([
          axios.get(
            "https://backend-tienda-mac-production-0992.up.railway.app/products/category/Smartphones/subcategory/iPhone/name/iPhone%2015%20Pro"
          ),
          axios.get(
            "https://backend-tienda-mac-production-0992.up.railway.app/products/category/Smartphones/subcategory/iPhone/name/iPhone%2015%20Pro%20Max"
          ),
        ]);
