...
const AirpodsMax = () => {
  ...
  useEffect(() => {
    const fetchAirpodsProducts = async () => {
      try {
        const response = await axios.get('https://backend-tienda-mac-production.up.railway.app/products/category/Audifonos/subcategory/Auriculares/name/AirPods%20Max');
  ...
  return (
    <div className="airpods-max-products">
      ...
      <div className="container py-5">
        <h1 className="text-center mb-4 fs-4" style={{ color: 'black' }}>Airpods Max</h1>
