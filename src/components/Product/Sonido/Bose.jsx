...
const Bose = () => {
  ...
  useEffect(() => {
    const fetchSonidoProducts = async () => {
      try {
        const response = await axios.get('https://backend-tienda-mac-production.up.railway.app/products/category/Parlantes/subcategory/Parlante%20Portátil');
  ...
  return (
    <div className="sonido-products">
      ...
      <div className="container py-5">
        <h1 className="text-center mb-4 fs-4" style={{ color: 'black' }}>BOSE</h1>
